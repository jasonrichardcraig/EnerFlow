...
public partial class EnerFlowContext : DbContext
{
    ...
    public virtual DbSet<CompressorDailyTransaction> CompressorDailyTransactions { get; set; }
    ...
    public virtual DbSet<MeterRunTag> MeterRunTags { get; set; }
    ...
    public virtual DbSet<SatelliteFlowRun> SatelliteFlowRuns { get; set; }
    ...
    public virtual DbSet<StringTag> StringTags { get; set; }

    public virtual DbSet<StringTagHistory> StringTagHistories { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AnalogIoTag>(entity =>
        {
            ...
            entity.HasOne(d => d.Device).WithMany(p => p.AnalogIoTags)
                .HasForeignKey(d => d.DeviceId)
                .HasConstraintName("FK_AnalogIoTags_DeviceTags");
        ...
        {
            entity.Property(e => e.Id).HasColumnName("ID");
            entity.Property(e => e.DailyFuelConsumption).HasColumnType("decimal(38, 12)");
            entity.Property(e => e.DateTimeCreated)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime");
            ...
            entity.Property(e => e.Name)
                .HasMaxLength(32)
                .IsUnicode(false);
            entity.Property(e => e.Throughput).HasColumnType("decimal(38, 12)");
            entity.Property(e => e.WellId).HasColumnName("WellID");

            entity.HasOne(d => d.Facility).WithMany(p => p.Compressors)
                .HasForeignKey(d => d.FacilityId)
                .HasConstraintName("FK_Compressors_Facilities");

            entity.HasOne(d => d.Well).WithMany(p => p.Compressors)
                .HasForeignKey(d => d.WellId)
                .HasConstraintName("FK_Compressors_Wells");
        });

        modelBuilder.Entity<CompressorDailyTransaction>(entity =>
        {
            entity.HasKey(e => new { e.CompressorId, e.TimeStamp });

            entity.Property(e => e.CompressorId).HasColumnName("CompressorID");
            entity.Property(e => e.CoolantJacketWaterTemperature).HasColumnType("decimal(38, 12)");
            entity.Property(e => e.DateTimeCreated)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime");
            entity.Property(e => e.HoursOn).HasColumnType("decimal(38, 12)");
            entity.Property(e => e.PercentRecycleOrSlide).HasColumnType("decimal(38, 12)");
            entity.Property(e => e.Rpm)
                .HasColumnType("decimal(38, 12)")
                .HasColumnName("RPM");

            entity.HasOne(d => d.Compressor).WithMany(p => p.CompressorDailyTransactions)
                .HasForeignKey(d => d.CompressorId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CompressorDailyTransactions_Compressors");
        });
        ...
        modelBuilder.Entity<DeviceTag>(entity =>
        {
            ...
            entity.Property(e => e.HierarchyId).HasColumnName("HierarchyID");
            entity.Property(e => e.IpendPoint)
                .HasMaxLength(255)
                .HasColumnName("IPEndPoint");
            ...
            entity.HasOne(d => d.DeviceType).WithMany(p => p.DeviceTags)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_DeviceTags_DeviceTypes");

            entity.HasOne(d => d.Hierarchy).WithMany(p => p.DeviceTags)
                .HasForeignKey(d => d.HierarchyId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_DeviceTags_Hierarchy");

            entity.HasOne(d => d.IdNavigation).WithOne(p => p.DeviceTag)
                .HasForeignKey<DeviceTag>(d => d.Id)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_DeviceTags_MeterTags");
        });
        ...
        modelBuilder.Entity<DigitalIoTag>(entity =>
        {
            ...
            entity.HasOne(d => d.Device).WithMany(p => p.DigitalIoTags)
                .HasForeignKey(d => d.DeviceId)
                .HasConstraintName("FK_DigitalIoTags_DeviceTags");
        ...
        modelBuilder.Entity<DigitalIoTagHistory>(entity =>
        {
            entity.HasKey(e => new { e.DigitalIoTagId, e.TimeStamp });

            entity.ToTable("DigitalIoTagHistory");
            ...
            entity.HasOne(d => d.DigitalIoTag).WithMany(p => p.DigitalIoTagHistories)
                .HasForeignKey(d => d.DigitalIoTagId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Meter>(entity =>
        {
            ...
            entity.Property(e => e.MeterRunTagId).HasColumnName("MeterRunTagID");
            entity.Property(e => e.Name)
                .HasMaxLength(32)
                .IsUnicode(false);
            entity.Property(e => e.SatelliteId).HasColumnName("SatelliteID");
            ...
            entity.HasOne(d => d.Facility).WithMany(p => p.Meters)
                .HasForeignKey(d => d.FacilityId)
                .HasConstraintName("FK_Meters_Facilities");
            ...
            entity.HasOne(d => d.MeterRunTag).WithMany(p => p.Meters)
                .HasForeignKey(d => d.MeterRunTagId)
                .HasConstraintName("FK_Meters_MeterRunTags");

            entity.HasOne(d => d.Satellite).WithMany(p => p.Meters)
                .HasForeignKey(d => d.SatelliteId)
                .HasConstraintName("FK_Meters_Satellites");

            entity.HasOne(d => d.Well).WithMany(p => p.Meters)
                .HasForeignKey(d => d.WellId)
                .HasConstraintName("FK_Meters_Wells");
        });
        ...
        modelBuilder.Entity<MeterRunTag>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Meters__3214EC276EB567C1");
            ...
            entity.HasOne(d => d.MeterExportType).WithMany(p => p.MeterRunTags)
                .HasForeignKey(d => d.MeterExportTypeId)
                .HasConstraintName("FK_MeterTags_MeterExportTypes");
        });
        ...
        modelBuilder.Entity<Pump>(entity =>
        {
            ...
            entity.HasOne(d => d.Facility).WithMany(p => p.Pumps)
                .HasForeignKey(d => d.FacilityId)
                .HasConstraintName("FK_Pumps_Facilities");
            ...
            entity.HasOne(d => d.Satellite).WithMany(p => p.Pumps)
                .HasForeignKey(d => d.SatelliteId)
                .HasConstraintName("FK_Pumps_Satellites");

            entity.HasOne(d => d.Well).WithMany(p => p.Pumps)
                .HasForeignKey(d => d.WellId)
                .HasConstraintName("FK_Pumps_Wells");
        });
        ...
        modelBuilder.Entity<Satellite>(entity =>
        {
            ...
            entity.Property(e => e.DateTimeCreated)
                ...
                .HasColumnType("datetime");
            entity.Property(e => e.FacilityId).HasColumnName("FacilityID");
            entity.Property(e => e.GroupMeterId).HasColumnName("GroupMeterID");
            entity.Property(e => e.HierarchyId).HasColumnName("HierarchyID");
            entity.Property(e => e.LocationName)
                .HasMaxLength(64)
                .IsUnicode(false);
            ...
            entity.HasOne(d => d.Facility).WithMany(p => p.Satellites)
                .HasForeignKey(d => d.FacilityId)
                .HasConstraintName("FK_Satellites_Facilities");

            entity.HasOne(d => d.GroupMeter).WithMany(p => p.Satellites)
                .HasForeignKey(d => d.GroupMeterId)
                .HasConstraintName("FK_Satellites_Meters");

            entity.HasOne(d => d.Hierarchy).WithMany(p => p.Satellites)
                .HasForeignKey(d => d.HierarchyId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Satellites_Hierarchy");
        });

        modelBuilder.Entity<SatelliteFlowRun>(entity =>
        {
            entity.Property(e => e.Id).HasColumnName("ID");
            entity.Property(e => e.DateTimeCreated)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime");
            entity.Property(e => e.GasMeterId).HasColumnName("GasMeterID");
            entity.Property(e => e.Name)
                .HasMaxLength(64)
                .IsUnicode(false);
            entity.Property(e => e.OilMeterId).HasColumnName("OilMeterID");
            entity.Property(e => e.SatelliteId).HasColumnName("SatelliteID");
            entity.Property(e => e.WaterMeterId).HasColumnName("WaterMeterID");

            entity.HasOne(d => d.GasMeter).WithMany(p => p.SatelliteFlowRunGasMeters)
                .HasForeignKey(d => d.GasMeterId)
                .HasConstraintName("FK_SatelliteFlowRuns_Meters");

            entity.HasOne(d => d.OilMeter).WithMany(p => p.SatelliteFlowRunOilMeters)
                .HasForeignKey(d => d.OilMeterId)
                .HasConstraintName("FK_SatelliteFlowRuns_Meters1");

            entity.HasOne(d => d.Satellite).WithMany(p => p.SatelliteFlowRuns)
                .HasForeignKey(d => d.SatelliteId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SatelliteFlowRuns_Satellites");

            entity.HasOne(d => d.WaterMeter).WithMany(p => p.SatelliteFlowRunWaterMeters)
                .HasForeignKey(d => d.WaterMeterId)
                .HasConstraintName("FK_SatelliteFlowRuns_Meters2");
        });
        ...
        modelBuilder.Entity<SerialChannelTag>(entity =>
        {
            ...
            entity.HasOne(d => d.Hierarchy).WithMany(p => p.SerialChannelTags)
                .HasForeignKey(d => d.HierarchyId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SerialChannelTags_Hierarchy");
        });
        ...
        modelBuilder.Entity<StringTag>(entity =>
        {
            entity.Property(e => e.Id).HasColumnName("ID");
            entity.Property(e => e.DateTimeCreated)
                .HasDefaultValueSql("(getdate())")
            ...
            entity.HasOne(d => d.Hierarchy).WithMany(p => p.StringTags)
                .HasForeignKey(d => d.HierarchyId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_StringTags_Hierarchy");
        });

        modelBuilder.Entity<StringTagHistory>(entity =>
        {
            entity.HasKey(e => new { e.StringTagId, e.TimeStamp });

            entity.ToTable("StringTagHistory");
            ...
            entity.HasOne(d => d.StringTag).WithMany(p => p.StringTagHistories)
                .HasForeignKey(d => d.StringTagId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_StringTagHistory_StringTags");
        });
        ...
        modelBuilder.Entity<Tank>(entity =>
        {
            ...
            entity.HasOne(d => d.Facility).WithMany(p => p.Tanks)
                .HasForeignKey(d => d.FacilityId)
                .HasConstraintName("FK_Tanks_Facilities");

            entity.HasOne(d => d.Satellite).WithMany(p => p.Tanks)
                .HasForeignKey(d => d.SatelliteId)
                .HasConstraintName("FK_Tanks_Satellites");
            ...
            entity.HasOne(d => d.Well).WithMany(p => p.Tanks)
                .HasForeignKey(d => d.WellId)
                .HasConstraintName("FK_Tanks_Wells");
        });
        ...
        modelBuilder.Entity<Well>(entity =>
        {
            ...
            entity.HasOne(d => d.Facility).WithMany(p => p.Wells)
                .HasForeignKey(d => d.FacilityId)
                .HasConstraintName("FK_Wells_Facilities");

            entity.HasOne(d => d.FacilityNavigation).WithMany(p => p.Wells)
                .HasForeignKey(d => d.FacilityId)
                .HasConstraintName("FK_Wells_Satellites");
        ...
        modelBuilder.Entity<WellTest>(entity =>
        {
            ...
            entity.HasOne(d => d.SatelliteFlowRun).WithMany(p => p.WellTests)
                .HasForeignKey(d => d.SatelliteFlowRunId)
                .HasConstraintName("FK_WellTests_SatelliteFlowRuns");
        });
